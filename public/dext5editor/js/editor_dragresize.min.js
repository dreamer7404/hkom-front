...
""!=a._config.dragResizeApplyDivClass&&(f=","+a._config.dragResizeApplyDivClass+",",0>f.indexOf(","+G_dextResize_OverElem.className+","))))return;DEXTTOP.G_CURREDITOR=a;G_ResizeHandlerActivatedFlag||setResizeIcon();DEXTTOP.DEXT5.util.addEvent(G_dextResize_OverElem,"mouseout",ResizeElmOutEvt)}}}catch(m){}}};
...
c.getElementsByTagName("th");d&&0<d.length||(d=c.getElementsByTagName("td"));setFocusChildForStyle(d[0],0);b=getFirstRange().range;DEXTTOP.G_CURREDITOR._LastRange=b}}catch(e){}null!=DEXTTOP.G_CURREDITOR._LastRange&&restoreSelection(null,!0);DEXTTOP.G_CURREDITOR._config.useMouseTableInoutdent&&(G_dextResize_elem_Rect=getClientRect(c),G_UseMouseTableInoutdent="TABLE"==c.nodeName?!0:!1);resizeHandleClear();G_dextResize_elem=c;clearInterval(dextResizeIconInterval);setResizeHandle(a,!0);G_CURSOR_ELEMENT=
c;"img"==c.nodeName.toLowerCase()&&(G_dextResize_Elem_Flag=!0);DEXTTOP.DEXT5.browser.ie&&9>DEXTTOP.DEXT5.browser.ieVersion&&stopDragElem()}),DEXTTOP.DEXT5.util.addEvent(G_dextResizeIcon,"dragstart",function(a){G_REMOVE_dextResizeIcon=!0;G_dextResizeIcon.parentNode&&(G_dextResizeIcon.parentNode.removeChild(G_dextResizeIcon),clearIfameOverDiv());G_dextResizeIcon=null;clearInterval(dextResizeIconInterval);dextResizeIconInterval=null;!DEXTTOP.DEXT5.browser.ie||9<DEXTTOP.DEXT5.browser.ieVersion?dragMoveStart(a,
G_dextResize_OverElem):DEXTTOP.DEXT5.util.cancelEvent(a)})),G_dextResizeIcon){G_REMOVE_dextResizeIcon=!1;var b=getElementOffset(_iframeWin.frameElement),a=getClientRect(G_dextResize_OverElem),c=0,d;0<=a.left&&(c=b.left+a.left);G_dextResizeIcon.style.left=c+"px";d="img"==G_dextResize_OverElem.nodeName.toLowerCase()?b.top+a.top:b.top+(a.top-13);G_dextResizeIcon.style.top=d+"px"}}catch(e){}};
...
startDragElem);DEXTTOP.DEXT5.util.addEvent(G_dextResizeHandleHolder,"mousedown",startDragElem)}a&&startDragElem(b,c)}catch(w){}};
...
DEXTTOP.DEXT5.util.cancelEvent(b)}catch(k){}};
...
n+1+"px"}else G_dextResize_elem.style.marginLeft=n+1+"px"}else G_dextResize_elem.style.left=d-k.left+h[0]-m.left+"px",G_dextResize_elem.style.top=e-k.top+h[1]-m.top+"px";setHandlePosition()}DEXTTOP.DEXT5.util.stopEvent(b);DEXTTOP.DEXT5.util.cancelEvent(b)}catch(l){}};
...
iframeDocLastMouseY=mouseY);if(!handle)return!0;G_firstDrag&&(0<DEXTTOP.G_CURREDITOR.UndoManager.charCount&&DEXTTOP.G_CURREDITOR.UndoManager.putUndo(),G_firstDrag=!1);var f=!1;if(this.resizeHandleDrag&&this.resizeHandleDrag(d,e))f=!0;else{var g=d,k=e;elmX+g<minLeft?mOffX=g-(d=minLeft-elmX):elmX+elmW+g>maxLeft&&(mOffX=g-(d=maxLeft-elmX-elmW));elmY+k<minTop?mOffY=k-(e=minTop-elmY):elmY+elmH+k>maxTop&&(mOffY=k-(e=maxTop-elmY-elmH));elmX+=d;elmY+=e}if(f){var h=getElementBorderWidth(),m=DEXTTOP.DEXT5.util.parseIntOr0(h.borderTopWidth)+
DEXTTOP.DEXT5.util.parseIntOr0(h.borderBottomWidth),n=DEXTTOP.DEXT5.util.parseIntOr0(G_dextResize_elem.style.paddingTop)+DEXTTOP.DEXT5.util.parseIntOr0(G_dextResize_elem.style.paddingBottom),q=G_dextResize_elem.style.width,p=G_dextResize_elem.style.height,l,f=0,w,x,y,g=0;if(-1<q.indexOf("%")||-1<p.indexOf("%")){var r=getClientRect(G_dextResize_elem);l=DEXTTOP.DEXT5.util.parseIntOr0(r.right-r.left);f=DEXTTOP.DEXT5.util.parseIntOr0(r.bottom-r.top);q&&-1<q.indexOf("%")&&(x=l,w=DEXTTOP.DEXT5.util.parseFloatOr0(q).toFixed(2));
p&&-1<p.indexOf("%")&&(g=f,y=DEXTTOP.DEXT5.util.parseFloatOr0(p).toFixed(2))}else if(l=DEXTTOP.DEXT5.util.parseIntOr0(q,10),f=DEXTTOP.DEXT5.util.parseIntOr0(p,10),0==l||0==f)r=getClientRect(G_dextResize_elem),0==l&&(l=DEXTTOP.DEXT5.util.parseIntOr0(r.right-r.left)),0==f&&(f=DEXTTOP.DEXT5.util.parseIntOr0(r.bottom-r.top));var t=handle&&handle.className&&handle.className.match(new RegExp(resizeName+"-([tmblr]{2})"))?RegExp.$1:"";if("IMG"==G_dextResize_elem.tagName&&(-1<t.indexOf("br")||-1<t.indexOf("bl")||
-1<t.indexOf("tl")||-1<t.indexOf("tr")))l=parseInt(elmW,10)-(m+n),f=parseInt(elmH,10)-(m+n),-1<q.indexOf("%")&&-1<p.indexOf("%")?setNodeWidthHeight(G_dextResize_elem,{width:DEXTTOP.DEXT5.util.parseFloatOr0(w*l/x).toFixed(2)+"%",height:DEXTTOP.DEXT5.util.parseFloatOr0(y*f/g).toFixed(2)+"%"}):-1<q.indexOf("%")?(setNodeWidthHeight(G_dextResize_elem,{width:DEXTTOP.DEXT5.util.parseFloatOr0(w*l/x).toFixed(2)+"%"}),""!=p&&setNodeWidthHeight(G_dextResize_elem,{height:f+"px"})):-1<p.indexOf("%")?(setNodeWidthHeight(G_dextResize_elem,
{height:DEXTTOP.DEXT5.util.parseFloatOr0(y*f/g).toFixed(2)+"%"}),""!=q&&setNodeWidthHeight(G_dextResize_elem,{width:l+"px"})):setNodeWidthHeight(G_dextResize_elem,{width:l+"px",height:DEXTTOP.DEXT5.util.parseIntOr0(1*l/G_ImageR)+"px"});else{if(0<=t.indexOf("l")||0<=t.indexOf("r"))l=parseInt(elmW,10)-(m+n),-1<q.indexOf("%")?setNodeWidthHeight(G_dextResize_elem,{width:DEXTTOP.DEXT5.util.parseFloatOr0(w*l/x).toFixed(2)+"%"}):setNodeWidthHeight(G_dextResize_elem,{width:l+"px"}),(""==G_dextResize_elem.style.height||
...
setNodeWidthHeight(G_dextResize_elem,{width:l+"px"})}"1"==DEXTTOP.G_CURREDITOR._config.dragResizeMovable&&(G_dextResize_elem.style.left=parseInt(elmX,10)+"px",G_dextResize_elem.style.top=parseInt(elmY,10)+"px");m=!1;n=[];if("table"==G_dextResize_elem.tagName.toLowerCase()){for(var m=!0,r=G_dextResize_elem,K=DEXTTOP.DEXT5.util.parseIntOr0(G_dextResize_elem.style.width,10),L=DEXTTOP.DEXT5.util.parseIntOr0(G_dextResize_elem.style.height,10),k=0,H=r.rows.length,h=0;h<H;h++)var A=r.rows[h],k=k+parseFloat(getClientRect(A.cells[0]).height);
for(h=0;h<H;h++){for(var A=r.rows[h],C=A.cells.length,I=0==h,B=0,u=0;u<C;u++)var v=A.cells[u],B=B+parseFloat(getClientRect(v).width);if((0<=t.indexOf("l")||0<=t.indexOf("r"))&&K!=B)for(B=(B-K)/C,u=0;u<C;u++){var v=A.cells[u],J=Math.floor(100*parseFloat(parseFloat(v.style.width.replace("px",""))-B+parseFloat(d/C)))/100;v.style.width=J+"px";v.width&&(v.width=J);if(I&&G_dextResize_elem.style.tableLayout&&"fixed"==G_dextResize_elem.style.tableLayout){var M=G_dextResize_elem.getElementsByTagName("colgroup");
if(0<M.length){var P=M[0].getElementsByTagName("col");n.push({col:P[u],width:J})}}}if((0<=t.indexOf("t")||0<=t.indexOf("b"))&&L!=k)for(I=(k-L)/H,u=0;u<C;u++){var v=A.cells[u],N=Math.floor(100*parseFloat(parseFloat(v.style.height.replace("px",""))-I+parseFloat(e/H)))/100;v.style.height=N+"px";v.height&&(v.height=N)}}}setHandlePosition();for(d=0;d<n.length;d++)n[d].col.style.width=n[d].width+"px",n[d].col.width=n[d].width;G_dextResizeHandleHolder.dext_resizeinfo.style.display="";G_dextResizeHandleHolder.dext_resizeinfo.style.zIndex=
1E6;G_dextResizeHandleHolder.dext_resizeinfo.style.top=handle.offsetTop+"px";G_dextResizeHandleHolder.dext_resizeinfo.style.left=handle.offsetLeft+"px";G_dextResizeHandleHolder.dext_resizeinfo.firstChild&&G_dextResizeHandleHolder.dext_resizeinfo.removeChild(G_dextResizeHandleHolder.dext_resizeinfo.firstChild);var D=document.createElement("span"),E=DEXTTOP.DEXT5.util.parseIntOr0(getNodeWidthHeight(G_dextResize_elem,"width"),10),z=DEXTTOP.DEXT5.util.parseIntOr0(getNodeWidthHeight(G_dextResize_elem,
"height"),10);if(7!=DEXTTOP.DEXT5.browser.ieVersion){var F=getNodeWidthHeight(G_dextResize_elem,"maxWidth");""!=F&&(F=DEXTTOP.DEXT5.util.parseIntOr0(F,10),E=E>F?F:E);var G=getNodeWidthHeight(G_dextResize_elem,"maxHeight");""==G||m||(G=DEXTTOP.DEXT5.util.parseIntOr0(G,10),z=z>G?G:z)}if(0==z)var O=getClientRect(G_dextResize_elem),z=DEXTTOP.DEXT5.util.parseIntOr0(O.bottom-O.top);-1<q.indexOf("%")&&-1<p.indexOf("%")?D.innerHTML=DEXTTOP.DEXT5.util.parseIntOr0(w*l/x)+"% X "+DEXTTOP.DEXT5.util.parseIntOr0(y*
f/g)+"%":-1<q.indexOf("%")?D.innerHTML=""==p?DEXTTOP.DEXT5.util.parseFloatOr0(w*l/x).toFixed(2)+"%":DEXTTOP.DEXT5.util.parseIntOr0(w*l/x)+"% X "+z:-1<p.indexOf("%")?D.innerHTML=""==q?DEXTTOP.DEXT5.util.parseFloatOr0(y*f/g).toFixed(2)+"%":E+" X "+DEXTTOP.DEXT5.util.parseIntOr0(y*f/g)+"%":D.innerHTML=E+" X "+z;G_dextResizeHandleHolder.dext_resizeinfo.appendChild(D)}G_dextResizeDiv&&(this.setDragResizeDivPosition(G_dextResizeDiv),this.setDragResizeDivSize(G_dextResizeDiv));DEXTTOP.DEXT5.util.cancelEvent(b)}catch(Q){}};
...
DEXTTOP.G_CURREDITOR._config.event.mouse("mouseup",b,G_dextResize_elem):DEXTTOP.DEXTWIN.dext_mouse_event("mouseup",b,G_dextResize_elem)}catch(q){}if(1==DEXTTOP.DEXT5.config.MouseEventCancel){DEXTTOP.DEXT5.util.cancelEvent(b);return}}docMouseY=docMouseX=topMouseY=topMouseX=null}catch(p){}};
DextDragResize.prototype.deselect=function(b){with(this)try{G_dextResizeHandleHolder&&(G_dextResizeHandleHolder.dext_resizeinfo.style.display="none",G_dextResizeHandleHolder.dext_resizeinfo.innerHTML=""),handle=null,mOffY=mOffX=0}catch(a){}};
DextDragResize.prototype.resizeHandleClear=function(){with(this)try{if(1==G_ResizeHandlerActivatedFlag){G_ResizeHandlerActivatedFlag=!1;return}stopDragElem();clearIfameOverDiv();removeDextResizeDiv();G_mouseOveriframeObj=G_dextResize_elem=G_dextResizeIcon=G_dextResize_OverElem=null}catch(b){}};
...
90==d||89==d||!c)&&resizeHandleClear();removePreventScrollMove()}catch(h){}};
